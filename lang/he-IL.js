export default () => {
  ...
  `
    ...
    <div class="members">
      ...
      <div class="member">דרור אלוביץ - מנהל תחום הדיגיטל במעבדת אליהו, אוניברסיטת חיפה.</div>
    ...
    translations.content.team.thanks = `<div class="team">
    <h3 class="header">
      <strong>צוות</strong>
      </h3>
      <h4>
